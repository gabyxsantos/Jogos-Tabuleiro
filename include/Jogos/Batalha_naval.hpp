...
class Batalha_Naval : public Jogo_De_Tabuleiro {
    private:
    int pontos_oponente = 0; // como o mapa que o jogador cria na verdade é utilizado pelo seu oponente para jogar, os pontos obtidos são referentes ao jogador que joga com o mapa, e não àquele que criou o mapa.
